...
exports.signup = catchAsync(async (req, res, next) => {
    console.log(req.body.name, req.body.email, req.body.password, req.body.passwordConfirm)
...
exports.adminLogin = catchAsync(async (req,res,next)=>{
    ...
    const {email,password} = req.body;
    if (!email || !password) {
        console.log("please provide your email & password")
        return next(new AppError("please provide your email & password"));
    }
...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    if (!currentUser) {
        ...
        return next(new AppError("The User belonging to thsi token no longer exist", 401));
    }
...
exports.resetPassword =async (req, res, next) => {
    ...
    console.log("user is ",user,hashedToken," ",req.params.token)
